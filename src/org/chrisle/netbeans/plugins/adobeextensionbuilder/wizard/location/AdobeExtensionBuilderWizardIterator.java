...
public class AdobeExtensionBuilderWizardIterator implements WizardDescriptor./*Progress*/InstantiatingIterator {
    ...
    public AdobeExtensionBuilderWizardIterator() {
    }

    public static AdobeExtensionBuilderWizardIterator createIterator() {
        return new AdobeExtensionBuilderWizardIterator();
    }
